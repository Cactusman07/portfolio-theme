...
<form role="search" method="get" class="cmp-search" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<input id="cmp-search-input" type="search" name="s" value="<?php echo esc_attr( get_search_query() ); ?>" placeholder="<?php esc_attr_e( 'search the workshop…', 'cactusman-portfolio' ); ?>">
