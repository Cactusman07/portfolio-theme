...
<main id="cmp-main" class="paper-page error-404">
	<header class="paper-page__head">
		...
		<p><?php esc_html_e( "The page you were looking for isn't here — try heading back to the home page, or use the search.", 'cactusman-portfolio' ); ?></p>
	</header>

	<div class="error-404__actions">
		<a class="btn btn-primary" href="<?php echo esc_url( home_url( '/' ) ); ?>">← <?php esc_html_e( 'back to home page', 'cactusman-portfolio' ); ?></a>
	</div>
